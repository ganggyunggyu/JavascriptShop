...
const addContent = (tabEl, tabConEl) =>{
...
tab[0].addEventListener('click',function(){addContent(tab[0],tabContent[0])})
tab[1].addEventListener('click',function(){addContent(tab[1],tabContent[1])})
tab[2].addEventListener('click',function(){addContent(tab[2],tabContent[2])})
